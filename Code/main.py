...
pygame.display.set_caption('Is This a Game?!')
...
necromancer_death_sound = pygame.mixer.Sound("sounds/death2.wav")
nightborne_death_sound = pygame.mixer.Sound("sounds/death2.wav")
...
class Enemy(pygame.sprite.Sprite): 
    ...
    def hunt_player(self):  
        if self.velocity.x > 0:
            ...
            self.current_movement_sprite = 1.75
